<template>
    <div v-show="isInfoVisible" class="content">
        ...
        <dark-card cardId="1" title="Common proxy" class="card" @change="   ">
            There is your daily routine with common app.
        </dark-card>
        <dark-card cardId="2" title="Common proxy" class="card">

        </dark-card>
        <dark-card cardId="3" title="Common proxy" class="card">
        ...
        <transition leave-active-class="fade-leave-active" leave-to-class="fade-leave-to"
            ...
            <div id="info-termynal" data-termynal data-ty-startDelay="0" class="termynal" v-show="isTermynalVisible">
                ...
                <span data-ty-typeDelay="100" data-ty="input" data-ty-delay="1000" data-ty-startDelay="1000"
                    class="linux-view" :data-ty-prompt="'infanasotku@server:~$'">sudo systemctl start xray</span>
